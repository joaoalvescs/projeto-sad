...
BEGIN
	...
	DECLARE @id INT, @rua VARCHAR(45), @numero VARCHAR(45), @cidade VARCHAR(45), @bairro VARCHAR(45), @estado VARCHAR(45), @cep VARCHAR(15)
	...
	OPEN C_ENDERECO
	FETCH C_ENDERECO INTO @id, @rua, @numero, @cidade, @bairro, @estado, @cep 

	WHILE(@@FETCH_STATUS = 0)
	BEGIN
		INSERT INTO TB_AUX_ENDERECO_CLIENTE
		VALUES(@id, @rua, @numero,@cidade, @bairro, @estado, @cep)
