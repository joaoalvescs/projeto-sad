...
/*CREATE TABLE TB_PRECO(
	...
	CONSTRAINT CK_INTEIRA_NEGATIVA CHECK((TIPO_PLANO = 'VIVO VALORIZA') OR (TIPO_PLANO ='MEIA ENTRADA') OR (TIPO_PLANO = 'INTEIRA') OR
										 (TIPO_PLANO = 'VALE CULTURA'))
);
*/
-- CRIADA EM 18/08/19
CREATE TABLE TB_PRECO(
...
-- ATUALIZADA EM 18/08/19
CREATE TABLE TB_POLTRONA(
	NUMERO_POLTRONA INT IDENTITY (1,1) NOT NULL,
	FILA VARCHAR(5) NOT NULL,
    STATUS_POLTRONA VARCHAR(25) NOT NULL,
	ID_SALA INT NOT NULL,
	CONSTRAINT PK_POLTRONA PRIMARY KEY (NUMERO_POLTRONA),
...
CREATE TABLE TB_INGRESSO(
    ...
    CONSTRAINT FK_POLTRONA FOREIGN KEY (NUM_POLTRONA) REFERENCES TB_POLTRONA(NUMERO_POLTRONA)
);
