...
CREATE PROCEDURE SP_OLTP_TB_AUX_FATO_VENDA_PRODUTO(@data DATETIME)
AS
BEGIN
...
CREATE PROCEDURE SP_OLTP_TB_AUX_CLIENTE (@data DATETIME)
AS
BEGIN
...
CREATE PROCEDURE SP_OLTP_TB_AUX_ENDERECO_CLIENTE(@data DATETIME)
AS 
BEGIN 
...
CREATE PROCEDURE SP_OLTP_TB_AUX_PLATAFORMA(@data DATETIME)
AS
BEGIN
...
CREATE PROCEDURE SP_OLTP_TB_AUX_PRODUTO(@data DATETIME)
AS
BEGIN
...
CREATE PROCEDURE SP_OLTP_TB_AUX_PAGAMENTO(@data DATETIME)
AS
BEGIN
...
CREATE PROCEDURE SP_OLTP_TB_AUX_CINEMA(@data DATETIME)
AS 
BEGIN
...
CREATE PROCEDURE SP_OLTP_TB_AUX_TURNO(@data DATETIME)
AS
BEGIN
